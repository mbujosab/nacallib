...
* La clase ~FuncionAfin~

*** Implementación de las funciones afines en la clase ~FuncionAfin~

**** Método de inicialización

#+name: Inicialización de la clase FuncionAfin
#+BEGIN_SRC python  :noweb no-export
def __init__(self, elementos_del_Dominio, elementos_de_la_Imagen):
    ...
    <<Verificación de que son Ok los argumentos para clase FuncionAfin>>
...
#+name: Verificación de que son Ok los argumentos para clase FuncionAfin
#+BEGIN_SRC python
...
*** Métodos la clase ~FuncionAfin~
:PROPERTIES:
:header-args+: :noweb-ref Métodos la clase ~FuncionAfin~
:END:
...
*** Métodos de representación de la clase ~FuncionAfin~

#+name: Métodos de representación de la clase ~FuncionAfin~
#+BEGIN_SRC python
...
#+name: Definición de la clase ~FuncionAfin~
#+BEGIN_SRC python :noweb no-export

class FuncionAfin:
    <<Inicialización de la clase FuncionAfin>>
    <<Métodos la clase ~FuncionAfin~>>
    <<Métodos de representación de la clase ~FuncionAfin~>>
...
<<Definición de la clase ~FuncionAfin~>>
#+END_SRC
