...
\label{sec:orge7952aa}

\subsubsection*{Introducción}
\label{sec:org00fc579}
...
valor del atributo \texttt{.corteSistema}). Pero si el \texttt{Sistema} es
...
\label{sec:orgd17dd64}

\subsection{Texto de ayuda}
\label{sec:orgb11514b}
...
\section{Implementación}
\label{sec:org977132c}
\subsection{Texto de ayuda}
\label{sec:org0112b1e}
...
\label{sec:org22e37f0}
\subsubsection{Rango de una Matrix}
\label{sec:orgd7e882d}
...
\label{sec:org24acfd3}

\chapter{La clase \texttt{T}}
\label{sec:orgb8f59e9}

\section{Introducción}
\label{sec:orge2e4e3a}
...
\label{sec:org0677613}

\subsection{Texto de ayuda}
\label{sec:orgaa2f670}
...
\label{sec:orgd18c2d6}

\subsection{Texto de ayuda}
\label{sec:org9a58d33}
...
\label{sec:org90a0d94}
\subsection{T es iterable}
\label{sec:orgab1c7f9}
...
\label{sec:orgbde74da}

\chapter{La clase \texttt{SubEspacio} (de \R[m])}
\label{sec:org8210dac}
...
\label{sec:orgd7bb817}

\subsection{Método de inicialización}
\label{sec:org19fda0f}
...
\label{sec:orgb3012ff}

\section{Números}
\label{sec:orgd439008}
