...
\label{sec:orga982daf}

\subsection{Texto de ayuda}
\label{sec:orgd338b28}
...
\section{Implementación}
\label{sec:org006ba13}
\subsection{Texto de ayuda}
\label{sec:org1541131}
...
\label{sec:orge7071d2}
\subsubsection{Rango de una Matrix}
\label{sec:org72a117e}
...
\label{sec:org1734838}

\subsection{Texto de ayuda}
\label{sec:org75cdafd}
...
\label{sec:org84bad69}

\subsection{Texto de ayuda}
\label{sec:org814f04b}
...
\label{sec:orgbf4b534}
\subsection{T es iterable}
\label{sec:org0e8553f}
...
\label{sec:org1bfe58c}

\chapter{La clase \texttt{SubEspacio} (de \R[m])}
\label{sec:orgcbb222c}
...
\label{sec:org937170f}

\section{Números}
\label{sec:org860d458}
